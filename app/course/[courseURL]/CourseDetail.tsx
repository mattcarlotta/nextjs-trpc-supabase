    ...
    return (
        <Main>
            <div className="w-full max-w-6xl grid-cols-1 gap-4 lg:grid lg:grid-cols-4">
                <div
                    className={cn(
                        "space-y-4 rounded-lg border border-neutral-300 bg-white p-6 shadow-lg",
                ...
                <aside
                    className={cn(
                        "hidden max-h-max border border-neutral-300 bg-white px-3 pt-3 pb-4 shadow-lg",
                        "dark:border-neutral-600 dark:bg-neutral-900",
                        "lg:col-span-1 lg:block lg:rounded-lg"
                    )}
                >
                    <div
                        aria-hidden
